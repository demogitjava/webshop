...
@EnableJpaRepositories(basePackages = "de.jgsoftware.webshop.dao.interfaces.mawi", entityManagerFactoryRef = "mawiEntityManagerFactory", transactionManagerRef = "mawiTransactionManager")
public class MaWiDBConfig extends HikariConfig {
	...
	public LocalContainerEntityManagerFactoryBean mawiEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource1).properties(properties).packages("de.jgsoftware.webshop.model.jpa.mawi")
				.persistenceUnit("derbymawi").build();
	}
